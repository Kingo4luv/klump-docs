...
interface ErrorsLayoutLayoutProps {
    children: ReactNode;
...
export default function ErrorsLayout({ children, readingTime, date, title }: ErrorsLayoutLayoutProps) {
    return (
                ...
                <div className="sticky top-24 pt-4">
                    ...
                    <ul className="border-l border-gray-200 pl-4 text-sm text-gray-600">
                        <li className='flex space-x-1 items-center'>
                            ...
                            <a href="#errors" className="text-[#192C69] font-medium">Errors</a></li>
                    </ul>
                </div>
            </aside>
        </div>
