...
export default function IntoLayout({ children, readingTime, date, title }: IntoLayoutProps) {
    return (
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-6 lg:flex gap-8">
            ...
            <div className="w-full lg:w-3/4">
               ...
               <div className="w-full lg:w-[821px] h-[419px ">
                ...
                <Callout title="Do you need help with integration?" type="help">
                    Do you need help with your integration or do you need to ask questions? Kindly join our Slack Worskpace here <a href='https://useklump.com/slack' className='text-indigo-600'>https://useklump.com/slack</a>
                </Callout>
                <FeedbackBox />
            </div>
