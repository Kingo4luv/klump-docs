...
import PaymentPages from '../img/integrating-klump/PaymentPages';
import Transaction from '../img/integrating-klump/Transaction';
...
const features = [
    ...
    },
    {
        title: 'Payment Pages',
        description:
            'Use our paymemt pages to receive payment for your product and services',
        image: PaymentPages,
    },
];
