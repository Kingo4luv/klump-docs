...
const CommerceIcon = (props) => (
    ...
    >
        <g clipPath="url(#a)">
            ...
            />
            <path
                d="M61.527 15a3.75 3.75 0 0 1 3.75-3.75h168.271a3.75 3.75 0 0 1 3.75 3.75v21.297H61.527z"
                fill="#fff"
                stroke="#E2E6EF"
                strokeWidth={0.5}
            />
            ...
            <g filter="url(#d)">
                ...
                />
                <path
                    d="M86.14 57.855h53.369V52a5 5 0 0 0-5-5H91.141a5 5 0 0 0-5 5z"
                    fill="#192C69"
                />
                <path
                    d="M91.07 55.714v-4.932h3.268v.85h-2.235v1.19h2.109v.793h-2.109v1.248h2.235v.85zm4.256 0V51.95h.998v.58h.062c.17-.406.543-.662 1.08-.662.837 0 1.288.512 1.288 1.411v2.434h-.998v-2.208c0-.53-.218-.81-.69-.81-.462 0-.742.331-.742.84v2.178zm5.278 0-1.31-3.763h1.07l.78 2.83h.061l.773-2.83h1.049l-1.302 3.763zm3.605-4.341a.56.56 0 0 1-.563-.554.56.56 0 0 1 .563-.557c.308 0 .561.246.561.557a.557.557 0 0 1-.561.554m-.502 4.34v-3.762h.998v3.763zm2.003 0v-3.762h.998v.584h.062c.119-.407.461-.646.95-.646.133 0 .273.02.372.048v.872a2 2 0 0 0-.458-.058c-.567 0-.926.324-.926.857v2.106zm4.631.08c-1.158 0-1.856-.735-1.856-1.959v-.007c0-1.213.708-1.958 1.856-1.958s1.856.741 1.856 1.958v.007c0 1.227-.697 1.958-1.856 1.958m0-.783c.53 0 .834-.434.834-1.176v-.007c0-.735-.307-1.176-.834-1.176-.529 0-.834.441-.834 1.176v.007c0 .742.301 1.176.834 1.176m2.67.704V51.95h.998v.58h.061c.171-.406.544-.662 1.08-.662.838 0 1.289.512 1.289 1.411v2.434h-.998v-2.208c0-.53-.219-.81-.691-.81-.461 0-.741.331-.741.84v2.178zm4.395 0V51.95h.998v.588h.062c.16-.424.55-.67 1.042-.67.513 0 .892.26 1.046.694h.062c.171-.418.608-.694 1.134-.694.749 0 1.217.485 1.217 1.26v2.585h-.998v-2.335q.002-.682-.622-.683c-.403 0-.663.297-.663.704v2.314h-.998v-2.379c0-.403-.229-.64-.619-.64-.389 0-.663.319-.663.75v2.269zm8.183.078c-1.145 0-1.839-.748-1.839-1.955v-.003c0-1.196.701-1.965 1.798-1.965s1.781.752 1.781 1.89v.31h-2.591c.01.62.342.978.871.978.438 0 .681-.232.749-.376l.01-.02h.93l-.007.034c-.116.472-.602 1.107-1.702 1.107m-.024-3.175c-.434 0-.755.294-.817.827h1.624c-.062-.547-.373-.827-.807-.827m2.581 3.097V51.95h.998v.58h.061c.171-.406.544-.662 1.08-.662.838 0 1.289.512 1.289 1.411v2.434h-.998v-2.208c0-.53-.219-.81-.691-.81-.461 0-.741.331-.741.84v2.178zm5.957.014c-.916 0-1.285-.298-1.285-1.03v-1.995h-.581v-.752h.581v-.9h1.008v.9h.776v.752h-.776v1.767c0 .338.144.489.482.489.13 0 .198-.007.294-.018v.742a3 3 0 0 1-.499.044"
                    fill="#fff"
                />
                <rect x={85} y={65} width={28} height={28} rx={5} fill="#E1E1F9" />
                <g clipPath="url(#e)" fill="#192C69">
                    <path d="M102.141 74.565h-5.427a2.15 2.15 0 0 0-2.149 2.149v5.427a2.15 2.15 0 0 0 2.148 2.148h5.428a2.15 2.15 0 0 0 2.144-2.116v-5.46a2.15 2.15 0 0 0-2.144-2.148m1.47 6.672-1.891-2.162a1.283 1.283 0 0 0-1.872 0l-1.298 1.483-.425-.516a1.248 1.248 0 0 0-1.918 0l-.963 1.163v-4.491a1.475 1.475 0 0 1 1.47-1.47h5.427a1.475 1.475 0 0 1 1.47 1.47z" />
                    <path d="M97.166 78.07a.904.904 0 1 0 0-1.808.904.904 0 0 0 0 1.809" />
                </g>
                <rect x={86} y={100} width={115} height={6} rx={2} fill="#E1EAF1" />
                <rect x={118} y={69} width={85} height={13} rx={2} fill="#E1EAF1" />
                <rect x={86} y={110} width={34} height={4} rx={2} fill="#E1EAF1" />
                <rect x={123} y={110} width={34} height={4} rx={2} fill="#E1EAF1" />
                <rect x={160} y={110} width={34} height={4} rx={2} fill="#E1EAF1" />
                <rect x={118} y={85} width={58} height={4} rx={2} fill="#E1EAF1" />
                <rect
                    x={86.141}
                    y={120.404}
                    width={62.414}
        ...
        <defs>
            ...
            <clipPath id="e">
                <path fill="#fff" d="M94 74h10.854v10.854H94z" />
            </clipPath>
            <linearGradient
                id="c"
                x1={150}
            ...
            >
                ...
                <feBlend
                    ...
                    result="effect1_dropShadow_157_28266"
                />
                <feBlend
                    in="SourceGraphic"
                    in2="effect1_dropShadow_157_28266"
                    result="shape"
                />
            </filter>
        </defs>
