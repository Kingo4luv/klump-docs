                ...
                <article className="prose prose-blue max-w-none space-y-8 my-6  text-base text-[#1F1F2D]">
                    ...
                    <div className='border-t border-[#E3E8EE] pt-6 space-y-6 lg:space-y-12'>
                        <div>
                            ...
                            <h2 className='text-lg text-[#1F1F2D] font-semibold mt-3'>Phone Number & OTP PIN</h2>
                            <p className='mb-4'>When you enter a phone number at the OTP (one-time-password screen), you will get a notification that says OTP has been sent to your mobile phone. Please use 12345 as the default entry. When you switch your account to LIVE, an OTP will be sent to your mobile number.</p>
                        ...
                        <div>
                            ...
                            <h2 className='text-lg text-[#1F1F2D] font-semibold mt-3'>Bio Data</h2>
                            <p className='mb-4'>Please use the following information for the biodata section - First name(Samuel) (Last name)Olamide</p>
                        </div>
                        <div>
                            <span>
                                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h2 className='text-lg text-[#1F1F2D] font-semibold mt-3'>ID Verification</h2>
                            <p className='mb-4'>We recommend selecting the driver's license option and using the following number ABC12345DE67.</p>
                        </div>
                        <div>
                            <span>
                                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h2 className='text-lg text-[#1F1F2D] font-semibold mt-3'>Test Bank Account</h2>
                            <p className='mb-4'>When you get to the screen where you're asked to link your bank account, follow the prompt and continue. When you see the list of banks, kindly select Stanbic, Polaris, etc and proceed to link your account using the credentials provided here. On this screen, click the button that says "fill with test data" and you should be able to link an account.</p>
                        </div>
                        <div>
                            <span>
                                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h2 className='text-lg text-[#1F1F2D] font-semibold mt-3'>Test Credentials</h2>
                            <p className='mb-4'>We encourage you to use the test credentials we have provided here.</p>
                        </div>
                        <div>
                            <span>
                                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h2 className='text-lg text-[#1F1F2D] font-semibold mt-3'>Emails</h2>
                            <p className='mb-4'>Please use a disposable email as much as you can. You can generate one here - https://temp-mail.org/en/. If you don't use a disposable email and use an email that isn't functional, our email service provider penalizes us for that. Now we don't want that, do we?</p>
                        </div>
                        <div>
                            <span>
                                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h2 className='text-lg text-[#1F1F2D] font-semibold mt-3'>Password</h2>
                            <p className='mb-4'>As much as you can, use a password with a combination of at least one upper case, lower case, special character and a number. Eg - Password@1.</p>
                        </div>
                    </div>
